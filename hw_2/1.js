...
const userInputNumber1 = +prompt('Введите положительное число');
const userInputNumber2 = +prompt('Введите отрицательное число');
alert(userInputNumber1 > 0 && userInputNumber2 < 0 ? "Все значения верные." : "Одно или более значений некорректно.");
